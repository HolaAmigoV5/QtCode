...
void MainWindow::createChart()
{
    ...
    series1->setName("QSplineSeries 曲线");
    ...
    connect(series1, &QLineSeries::clicked, this, &MainWindow::do_series_clicked);
    connect(series1, &QLineSeries::hovered, this, &MainWindow::do_series_hovered);
...
{
    QPointF pt=chart->mapToValue(point);    //转换为chart中的值(time, value);
