...
void MainWindow::do_mouseDoubleClicked(QPoint point)
{
    ...
    switch(item->type()){
        ...
        case QGraphicsTextItem::Type:
            ...
            bool ok=false;
            font=QFontDialog::getFont(&ok, font,nullptr,"选择字体");
            if(ok)
...
void MainWindow::on_actItem_Ecllipse_triggered()
{
...
{
    QString helpFile=QCoreApplication::applicationDirPath()+"/osgEarth用户手册.pdf";
