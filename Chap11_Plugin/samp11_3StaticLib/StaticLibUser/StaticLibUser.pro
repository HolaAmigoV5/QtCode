...
else:win32:CONFIG(debug, debug|release): LIBS += -L$$PWD/include/ -lMyStaticLib

INCLUDEPATH += $$PWD/include
DEPENDPATH += $$PWD/include

win32-g++:CONFIG(release, debug|release): PRE_TARGETDEPS += $$PWD/include/libMyStaticLib.a
else:win32-g++:CONFIG(debug, debug|release): PRE_TARGETDEPS += $$PWD/include/libMyStaticLib.a
